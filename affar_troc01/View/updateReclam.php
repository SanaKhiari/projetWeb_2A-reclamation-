...
if (
   ...
   if (
        ...
        $reclamationC->updateReclam($reclamation, $_POST["id_rec"]);
...
<body>
    ...
    <h2>
        <a href="ListeReclamation.php">Retoure a la liste de reclamation</a> 
    </h2>
    <hr> -->
        ...
        <form action="" method="POST">
            <table border="1" align="center">
                ...
                <tr>
                    ...
                    <td><input type="text" name="type" id="type" value="<?php echo $reclamation['type']; ?>" maxlength="20"></td>
                </tr>
                <tr>
                    <td>
                        <label for="text_rec">text:
                        </label>
                    </td>
                    <td>
                        <textarea name="text_rec" id="text_rec" value="<?php echo $reclamation['text_rec']; ?>" rows=5 cols="50"></textarea>
                    </td>
