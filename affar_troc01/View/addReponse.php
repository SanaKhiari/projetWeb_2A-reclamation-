    ...
    if (
      //  !empty($_POST["id_rec"]) &&
        ...
        $reponseC->addReponse($rep);
         header('Location:reponseAjoutee.php');
    } else
...
<body>
    ...
    <!-- <h1>
        <a href="listeReponse.php" >Retour a la liste </a>
    </h1> -->
    <hr>
    ...
    <form action="" method="POST">
        ...
        <tr>
                <td>
                    <label for="id_rec">Entrer l'identifiant de la reclamation : </label>
                </td>
                <td>
                    ...
                    ?> <option name="id_rec_select" value="<?php echo $list['id_rec']; ?>"><?= $list['id_rec']; ?></option> -->
                    <?php
                    }
                    ?> 
